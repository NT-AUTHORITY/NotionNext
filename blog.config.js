...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'KRNL32', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'NT-AUTHORITY', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://krnl32.win', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://cdn.jsdelivr.net/gh/NT-AUTHORITY/NT-AUTHORITY@main/assets/avatar-256.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  GREETING_WORDS:
    ...
    'Hello from NT.,Thanks for visiting.',
